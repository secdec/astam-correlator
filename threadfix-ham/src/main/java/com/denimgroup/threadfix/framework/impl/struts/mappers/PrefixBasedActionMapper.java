...
public class PrefixBasedActionMapper extends Mapper {
    public PrefixBasedActionMapper(StrutsConfigurationProperties configProperties, Collection<StrutsPackage> packages) {
