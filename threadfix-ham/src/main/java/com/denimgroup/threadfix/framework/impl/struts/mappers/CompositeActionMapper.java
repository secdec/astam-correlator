...
public class CompositeActionMapper extends Mapper {

    public CompositeActionMapper(StrutsConfigurationProperties configProperties, Collection<StrutsPackage> packages) {
