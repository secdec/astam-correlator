...
public class AutoGeneratedParameterNameTests {
    ...
    public void testContosoGeneratedProperties() {
        ...
        checkParameters(TestConstants.WEB_FORMS_CONTOSO, "/StudentsAdd.aspx", "POST", params);
    }

    //  TODO - Re-enable
    //  The original data set for this test can't be found. The referenced project is correct, but some changes
    //  must have been made to that source by the original tests.
//    @Test
...
//    }
    ...
    private void checkParameters(String databaseLocation, String endpointUrl, String httpMethod, String... params) {
        ...
        checkParameters(database, endpointUrl, httpMethod, params);
    }

    // having this separate enables us to reuse a database between test calls to save parsing time
    private void checkParameters(EndpointDatabase database, String endpointUrl, String httpMethod, String... params) {
        EndpointQuery query =
        ...
        for (String param : params) {
            assert endpoint.getParameters().keySet().contains(param) :
