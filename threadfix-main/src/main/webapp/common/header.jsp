				...
				<td id="tab-config" style="width: 30px;padding-left:0;">
					...
					<ul id="configurationHeader" class="dropdown-menu pull-right config-header" style="text-align:right;">
                        ...
                        <security:authorize access="hasAnyRole(
                                ...
                                'ROLE_CAN_MANAGE_ROLES',
                                'ROLE_CAN_MANAGE_GROUPS',
                                'ROLE_CAN_MANAGE_API_KEYS',
                                'ROLE_CAN_MANAGE_EMAIL_REPORTS')">
                            <li class="dropdown-submenu left pull-left normalLinks">
                                <ul class="dropdown-menu"
                                    style="text-align:right; left: -177px;"
                                    tabindex="-1">
                                    <security:authorize access="hasRole(
                                            'ROLE_CAN_MANAGE_SYSTEM_SETTINGS')">
                                        <li class="normalLinks">
                                            <a id="configureDefaultsLink"
                                               href="<spring:url value="/configuration/settings" htmlEscape="true"/>">System
                                                Settings</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                            'ROLE_CAN_MANAGE_USERS')">
                                        <li class="normalLinks">
                                            <a id="manageUsersLink"
                                               href="<spring:url value="/configuration/users" htmlEscape="true"/>">Users</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                            'ROLE_ENTERPRISE') and
                                            hasRole('ROLE_CAN_MANAGE_ROLES')">
                                        <li class="normalLinks">
                                            <a id="manageRolesLink"
                                               href="<spring:url value="/configuration/roles" htmlEscape="true"/>">Roles</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                            'ROLE_ENTERPRISE') and
                                            hasRole('ROLE_CAN_MANAGE_GROUPS')">
                                        <li class="normalLinks">
                                            <a id="manageGroupsLink"
                                               href="<spring:url value="/configuration/groups" htmlEscape="true"/>">Groups</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                            'ROLE_CAN_MANAGE_API_KEYS')">
                                        <li class="normalLinks">
                                            <a id="apiKeysLink"
                                               href="<spring:url value="/configuration/keys" htmlEscape="true"/>">API
                                                Keys</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                            'ROLE_CAN_MANAGE_EMAIL_REPORTS')">
                                        <li class="normalLinks">
                                            <a id="emailReportConfiguration"
                                               href="<spring:url value="/configuration/scheduledEmailReports" htmlEscape="true"/>">Email
                                                Reports</a>
                                        </li>
                                    </security:authorize>
                                    <security:authorize access="hasRole(
                                        ...
                                        <li class="normalLinks">
                                            <a id="emailListsLink"
                                               href="<spring:url value="/configuration/emailLists" htmlEscape="true"/>">Email
                                                Lists</a>
                                        </li>
                                    </security:authorize>
                                </ul>
                        ...
                        <security:authorize access="hasRole('ROLE_ENTERPRISE')">
                            <li class="normalLinks">
                                <a id="historyLink"
                                   href="<spring:url value="/history" htmlEscape="true"/>">History</a>
                            </li>
                        </security:authorize>
                        <li class="normalLinks">
                            <a id="viewDownloadPageLink"
                               href="<spring:url value="/configuration/download" htmlEscape="true"/>">Download
                                Tools</a>
                        </li>
                        <security:authorize access="hasRole(
                            ...
                            <li class="normalLinks">
                                <a id="viewLogsLink"
                                   href="<spring:url value="/configuration/logs" htmlEscape="true"/>">Error
                                    Messages</a>
                            </li>
                        </security:authorize>
                        <li class="normalLinks">
                            <a id="viewAboutPageLink"
                               href="<spring:url value="/about" htmlEscape="true"/>">About</a>
                        </li>
                    </ul>
				   </div>
				</td>
