 ...
 */
public class AstamMessageSubscriber implements Runnable {

    private static final SanitizedLogger LOGGER = new SanitizedLogger(AstamMessageSubscriber.class);

    private Connection connection;
    private Session session;
    private String topicString;
    private AstamMessageTrigger messageTrigger;


    public AstamMessageSubscriber(@Nonnull Connection connection, @Nonnull String topicString){
        this.connection = connection;
        this.topicString = topicString;
        messageTrigger = new AstamMessageTrigger();
    }
